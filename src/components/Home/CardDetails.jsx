        ...
        <div className="py-6 w-[90%] m-auto">
            <div className=" relative">
                ...
                <div className="h-24 w-full bg-black bg-opacity-50 absolute bottom-0 ">
                    <button onClick={handleClickData} className=" absolute bottom-6 left-7 py-2 px-3 rounded-md text-xl text-white font-semibold shadow-black shadow-2xl" style={{backgroundColor:text_color}}>Donate ${price}</button>
                </div>
            </div> 
